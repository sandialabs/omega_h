...
function(bob_cmake_arg2 var type)
...
function(bob_cmake_arg var type)
message(STATUS "${var}: ${${var}}")
bob_cmake_arg2("${var}" "${type}")
endfunction()
...
macro(bob_begin_package)
  ...
  bob_cmake_arg(USE_XSDK_DEFAULTS BOOL)
  ...
  bob_cmake_arg(BUILD_TESTING BOOL)
  bob_cmake_arg(BUILD_SHARED_LIBS BOOL)
...
function(bob_begin_cxx_flags)
  if (USE_XSDK_DEFAULTS)
    ...
    bob_cmake_arg(${PROJECT_NAME}_CXX_OPTIMIZE BOOL)
    bob_cmake_arg(${PROJECT_NAME}_CXX_SYMBOLS BOOL)
    bob_cmake_arg(${PROJECT_NAME}_CXX_WARNINGS BOOL)
    set(FLAGS "")
...
macro(bob_add_dependency)
  ...
  set(oneValueArgs NAME INCLUDE_DIRS_VAR LIBRARIES_VAR)
  ...
  if (USE_XSDK_DEFAULTS)
    ...
    if(${PROJECT_NAME}_USE_${ARG_NAME})
      ...
      bob_cmake_arg(${ARG_NAME}_PREFIX PATH)
      if (${ARG_NAME}_PREFIX)
      ...
      if (ARG_LIBRARIES_VAR)
        target_link_libraries(${tgt} INTERFACE ${${ARG_LIBRARIES_VAR}})
      endif()
...
function(bob_install_provenance)
  ...
  foreach(tgt IN LISTS ${PROJECT_NAME}_EXPORTED_TARGETS)
    ...
    if (tgt_type MATCHES "STATIC_LIBRARY|SHARED_LIBRARY")
      message("top-call bob_get_link_libs(${tgt})")
