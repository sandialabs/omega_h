...
MACRO(XSDK_HANDLE_LANG_DEFAULTS  CMAKE_LANG_NAME  ENV_LANG_NAME
  ...
  IF (NOT "$ENV{${ENV_LANG_NAME}}" STREQUAL "" AND
    ...
    MESSAGE(STATUS "XSDK: Setting CMAKE_${CMAKE_LANG_NAME}_COMPILER from env var"
  ...
  FOREACH(ENV_LANG_FLAGS_NAME  ${ENV_LANG_FLAGS_NAMES})
    IF (NOT "$ENV{${ENV_LANG_FLAGS_NAME}}" STREQUAL "" AND
      ...
      MESSAGE(STATUS "XSDK: Setting CMAKE_${CMAKE_LANG_NAME}_FLAGS from env var"
...
IF (USE_XSDK_DEFAULTS)
  ...
  IF ("${BUILD_SHARED_LIBS}"  STREQUAL  "")
    MESSAGE(STATUS "XSDK: Setting default BUILD_SHARED_LIBS=TRUE")
    SET(BUILD_SHARED_LIBS  TRUE  CACHE  BOOL  "Set by default in XSDK mode")
  ENDIF()
  
  IF ("${CMAKE_BUILD_TYPE}"  STREQUAL  "")
    MESSAGE(STATUS "XSDK: Setting default CMAKE_BUILD_TYPE=DEBUG")
