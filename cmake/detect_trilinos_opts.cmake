...
function(detect_trilinos_opts)
  ...
  if (TeuchosParameterList_FOUND)
    list(FIND TeuchosParameterList_TPL_LIST "yaml-cpp" YAML_CPP_IDX)
    if (${YAML_CPP_IDX} GREATER -1)
      message(STATUS "TeuchosParameterList has YAML")
      set(TeuchosParameterList_HAS_YAML TRUE PARENT_SCOPE)
    endif()
  endif()
