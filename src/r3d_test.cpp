...
static void test_3d() {
  ...
  OMEGA_H_CHECK(
      Omega_h::are_close(faces[0].n, -Omega_h::normalize(Omega_h::vector_3(1, 1, 1))));
  ...
  auto b =
      Omega_h::r3d::clip(a, Omega_h::Few<Omega_h::r3d::Plane<3>, 1>({{{1, 0, 0}, -0.5}}));
  ...
  OMEGA_H_CHECK(Omega_h::are_close(volume, (1. / 6.) - (Omega_h::cube(0.5) / 6.)));
  Omega_h::Few<Omega_h::Vector<3>, 4> verts2 = {
      {1, 0, 0}, {1, 1, 0}, {0, 0, 0}, {1, 0, 1}};
  volume = Omega_h::r3d::measure(Omega_h::r3d::intersect_simplices(verts, verts2));
...
static void test_2d() {
  ...
  OMEGA_H_CHECK(Omega_h::are_close(faces[1].n, -Omega_h::normalize(Omega_h::vector_2(1, 1))));
  ...
  auto b = Omega_h::r3d::clip(a, Omega_h::Few<Omega_h::r3d::Plane<2>, 1>({{{1, 0}, -0.5}}));
  OMEGA_H_CHECK(b.nverts == 3);
  auto area = Omega_h::r3d::measure(b);
  OMEGA_H_CHECK(Omega_h::are_close(area, Omega_h::square(0.5) / 2.0));
  auto c = Omega_h::r3d::clip(a, Omega_h::Few<Omega_h::r3d::Plane<2>, 1>({{{-1, 0}, 0.5}}));
  OMEGA_H_CHECK(c.nverts == 4);
  area = Omega_h::r3d::measure(c);
  OMEGA_H_CHECK(Omega_h::are_close(area, (1. / 2.) - (Omega_h::square(0.5) / 2.0)));
  Omega_h::Few<Omega_h::Vector<2>, 3> verts2 = {{0, 0}, {1, 0}, {1, 1}};
  area = Omega_h::r3d::measure(Omega_h::r3d::intersect_simplices(verts, verts2));
