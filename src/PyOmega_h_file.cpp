...
void pybind11_file(py::module& module) {
  ...
  void (*vtk_write_vtu_dim)(std::string const&, Mesh*, Int, bool) = &vtk::write_vtu;
  void (*vtk_write_vtu)(std::string const&, Mesh*, bool) = &vtk::write_vtu;
  void (*vtk_write_parallel_dim)(std::string const&, Mesh*, Int, bool) =
      &vtk::write_parallel;
  void (*vtk_write_parallel)(std::string const&, Mesh*, bool) = &vtk::write_parallel;
  ...
  module.def("vtk_write_vtu_dim", vtk_write_vtu_dim,
      ...
      py::arg("path"), py::arg("mesh"), py::arg("cell_dim"), py::arg("compress") = true);
