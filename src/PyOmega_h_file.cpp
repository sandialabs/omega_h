...
void pybind11_file(py::module& module) {
  ...
  void (*vtk_write_vtu_dim)(std::string const&, Mesh*, Int) = &vtk::write_vtu;
  void (*vtk_write_vtu)(std::string const&, Mesh*) = &vtk::write_vtu;
  void (*vtk_write_parallel_dim)(std::string const&, Mesh*, Int) = &vtk::write_parallel;
  void (*vtk_write_parallel)(std::string const&, Mesh*) = &vtk::write_parallel;
  ...
  module.def("vtk_write_vtu_dim", vtk_write_vtu_dim, "Write entities of one dimension as a .vtu file");
  module.def("vtk_write_parallel", vtk_write_parallel,
      "Write a mesh as a directory of parallel VTK files");
