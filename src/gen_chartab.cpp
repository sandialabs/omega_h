...
int main() {
  ...
  std::ofstream chartab_hpp("Omega_h_chartab.hpp");
  chartab_hpp << "/* This file was auto-generated by\n";
  chartab_hpp << "   gen_chartab */\n";
  chartab_hpp << "\n";
  chartab_hpp << "#ifndef OMEGA_H_CHARTAB_HPP\n";
  chartab_hpp << "#define OMEGA_H_CHARTAB_HPP\n";
  chartab_hpp << "\n";
  chartab_hpp << "namespace Omega_h {\n";
  chartab_hpp << "\n";
  chartab_hpp << "enum { NCHARS = " << n << " };\n";
  chartab_hpp << "\n";
  chartab_hpp << "#define OMEGA_H_CHARTAB_SIZE " << (SCHAR_MAX + 1) << '\n';
  chartab_hpp << "extern int const chartab[OMEGA_H_CHARTAB_SIZE];\n";
  chartab_hpp << "extern char const inv_chartab[NCHARS];\n";
  chartab_hpp << "\n";
  chartab_hpp << "}  // end namespace Omega_h\n";
  chartab_hpp << "\n";
  chartab_hpp << "#endif\n";
  chartab_hpp.close();
  std::ofstream chartab_cpp("Omega_h_chartab.cpp");
  chartab_cpp << "/* This file was auto-generated by\n";
  chartab_cpp << "   gen_chartab */\n";
  chartab_cpp << "\n";
  chartab_cpp << "#include \"Omega_h_chartab.hpp\"\n";
  chartab_cpp << "\n";
  chartab_cpp << "namespace Omega_h {\n";
  chartab_cpp << "\n";
  chartab_cpp << "int const chartab[OMEGA_H_CHARTAB_SIZE] = {\n";
  for (int i = 0; i <= SCHAR_MAX; ++i) {
  ...
  chartab_cpp << "};\n";
  chartab_cpp << "\n";
  chartab_cpp << "}  // end namespace Omega_h\n";
  chartab_cpp.close();
}
