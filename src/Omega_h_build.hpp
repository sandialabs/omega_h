...
// builds only non-vertex entities, expects build_verts_from_globals to be called first
...
void add_ents2verts(Mesh* mesh, Int edim, LOs ev2v, GOs vert_globals,
    GOs elem_globals = GOs());
