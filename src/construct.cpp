...
void build_from_elems2verts(
    Mesh* mesh, Int edim, LOs ev2v, LO nverts) {
  build_from_elems2verts(mesh, mesh->library()->self(), edim, ev2v, Read<GO>(nverts, 0, 1));
}

void build_from_elems_and_coords(
    Mesh* mesh, Int edim, LOs ev2v, Reals coords) {
