...
#if (defined(OMEGA_H_USE_CUDA) || defined(OMEGA_H_USE_HIP)) && !defined(OMEGA_H_USE_CUDA_AWARE_MPI)
...
#endif  // !defined(OMEGA_H_USE_CUDA) || defined(OMEGA_H_USE_HIP) || defined(OMEGA_H_USE_CUDA_AWARE_MPI)
