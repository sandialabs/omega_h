...
int main(int argc, char** argv) {
  ...
  auto vert_grad_grads = Omega_h::get_vert_grad_grad(&mesh, elem_jac_invs, elem_material_matrices, elem_sizes);
  auto edge_grad_grads = Omega_h::get_edge_grad_grad(&mesh, elem_jac_invs, elem_material_matrices, elem_sizes);
