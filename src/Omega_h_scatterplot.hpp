...
extern template Reals get_linear_scatter_coords(Reals coords, Vector<dim> direction, Vector<dim> origin); \
extern template Reals get_radial_scatter_coords(Reals coords, Vector<dim> center); \
extern template void write_linear_scatterplot(std::string const& path, Mesh* mesh, Int ent_dim, \
    Reals data, Vector<dim> direction, Vector<dim> origin, std::string const& separator); \
extern template void write_radial_scatterplot(std::string const& path, Mesh* mesh, Int ent_dim, \
    Reals data, Vector<dim> center, std::string const& separator);
