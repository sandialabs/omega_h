...
int main(int argc, char** argv) {
  ...
  osh::Read<osh::I8> marked_read =
      osh::mark_class_closures(&mesh, dim, class_dims, class_ids);
  ...
  typename Kokkos::View<osh::I8 const*>::HostMirror mirror =
      Kokkos::create_mirror_view(marked);
