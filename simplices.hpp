...
struct UpTemplate { I8 up; I8 which_down; };
CONSTANT static UpTemplate const fve0[] = {{0,0},{2,1}};
CONSTANT static UpTemplate const fve1[] = {{1,0},{0,1}};
CONSTANT static UpTemplate const fve2[] = {{2,0},{1,1}};
CONSTANT static UpTemplate const* const fve_[] = {
  fve0,fve1,fve2};
CONSTANT static UpTemplate const* const* const f_u_[] = {
  fve_};
CONSTANT static UpTemplate const rve0[] = {{0,0},{2,1},{3,0}};
CONSTANT static UpTemplate const rve1[] = {{1,0},{0,1},{4,0}};
CONSTANT static UpTemplate const rve2[] = {{2,0},{1,1},{5,0}};
CONSTANT static UpTemplate const rve3[] = {{3,1},{4,1},{5,1}};
CONSTANT static UpTemplate const* const rve_[] = {
  rve0,rve1,rve2,rve3};
CONSTANT static UpTemplate const ref0[] = {{0,2},{1,0}};
CONSTANT static UpTemplate const ref1[] = {{0,1},{2,0}};
CONSTANT static UpTemplate const ref2[] = {{0,0},{3,0}};
CONSTANT static UpTemplate const ref3[] = {{1,2},{3,1}};
CONSTANT static UpTemplate const ref4[] = {{2,2},{1,1}};
CONSTANT static UpTemplate const ref5[] = {{3,2},{2,1}};
...
CONSTANT static UpTemplate const* const* const r_u_[] = {
  rve_,ref_};
CONSTANT static UpTemplate const* const* const* const UpTemplates[] = {
  0,0,f_u_,r_u_};
